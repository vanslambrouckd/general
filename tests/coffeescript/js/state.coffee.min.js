(function() {
  var Camera3, User, calculateCost, calculateNumberSold, calculateProfit, calculateRevenue, cost, factorial, loadProductData, loadUserData, logUserDataFor, makeDbOperator, makeLoadData, makeSaveData, nr, numberSold, phototake500, price, revenue, revenueBetween, saveProductData, sold, withCachedCallback, _i, _j,
    __slice = [].slice;
